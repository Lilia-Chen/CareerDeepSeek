...
export async function writeTargetRecord(scoredTarget: ScoredTarget, options: WriteOptions = {}): Promise<string> {
...
function assertScoredTarget(scoredTarget: ScoredTarget): void {

...
const commandSpecs = [
  ...
  },
  {
    ...
    summary: 'Resolve a semantic target from OCR, AXTree, and Chrome DOM evidence, then foreground-click it.',
    namespace: 'action',
    driverId: 'macos.chrome',
  ...
  {
    id: 'chrome.typeInput',
    summary: 'Resolve an input field from AXTree and Chrome DOM evidence, foreground-focus it, and type text.',
    namespace: 'action',
    driverId: 'macos.chrome',
    operation: 'typeInput',
    mutatesPage: true,

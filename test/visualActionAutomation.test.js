...
test("normalizes visual state with screenshot and coordinate-grounded elements", () => {
...
test("allows visual click and type actions but blocks high-risk intents", () => {
...
test("verifies visual action progress after navigation", () => {
...
test("runs observe-action-observe visual session loop with mock computer-use adapter", async () => {
...
test("stops before acting when visual state exposes a stop condition", async () => {
...
test("converts a visual state into a collection page observation without raw visible text", () => {
